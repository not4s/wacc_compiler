...
class PointerSymbolTableTest {
    ...
    fun canGetInts() {
        val pointerSymbolTable = PointerSymbolTable()
        pointerSymbolTable.declare("x", WInt(1))
        assertEquals(pointerSymbolTable.get("x"), WInt(1))
    ...
    fun canGetStrings() {
        val pointerSymbolTable = PointerSymbolTable()
        pointerSymbolTable.declare("x", WStr("hi"))
        assertEquals(pointerSymbolTable.get("x"), WStr("hi"))
    }

    @Test
    fun canReassignInt() {
        val pointerSymbolTable = PointerSymbolTable()
        pointerSymbolTable.declare("x", WInt(3))
        pointerSymbolTable.reassign("x", WInt(5))
        assertEquals(pointerSymbolTable.get("x"), WInt(5))
    ...
    fun canReassignString() {
        val pointerSymbolTable = PointerSymbolTable()
        pointerSymbolTable.declare("x", WStr("hi"))
        pointerSymbolTable.reassign("x", WStr("hello"))
        assertEquals(pointerSymbolTable.get("x"), WStr("hello"))
    }
